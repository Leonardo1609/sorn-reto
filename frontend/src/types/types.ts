export const types = {
    ...
    setObservationsStatesPerUser : '[Users] Set Obsevations States Per User',
    ...
    modifyObservationDetail : '[Observations] Modify Observation Detail',
    wantEditDetail          : '[Observations] Want to Edit Detail?',
